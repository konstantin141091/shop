<template>
    <section class="benefit-list">
        ...
        <div class="benefit-list__box">
            <article>
                <img src="storage/icons/plus__1.svg" alt="Широкий ассортимент">
            ...
            <article>
                <img src="storage/icons/plus__2.svg" alt="Всегда свежие">
                <h4>Всегда свежие</h4>
                <p>Все продукты перевозятся в машинах-рефрижераторах с разными режимами температуры. Мы знаем, сколько градусов внутри каждой колбасы!</p>
            </article>

            <article>
                <img src="storage/icons/plus__3.svg" alt="Контроль качества">
